...
ylabel('Frequency');
xlim([-60 30]);
saveas(gcf,'no_w_filter_bg_s_fan.png');
figure;
...
ylabel('Frequency');
xlim([-60 30]);
saveas(gcf,'with_w_filter_bg_s_fan.png');
figure;

load('PI_dataset_LAYER0.mat');
load('PI_dataset_LAYER0pt5.mat');
load('PI_dataset_LAYER3.mat');
...
ylabel('Frequency');
xlim([-60 30]);
saveas(gcf,'no_w_filter_pi_s_fan.png');
figure;
...
ylabel('Frequency');
xlim([-60 30]);
saveas(gcf,'with_w_filter_pi_s_fan.png');
figure;
