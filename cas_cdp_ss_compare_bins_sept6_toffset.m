...
x_cdp = cdp_mean;
y_cdp = [nanmean(collect1.cdpbin1),nanmean(collect1.cdpbin2),nanmean(collect1.cdpbin3),nanmean(collect1.cdpbin4),...
    ...
    nanmean(collect1.cdpbin13),nanmean(collect1.cdpbin14),nanmean(collect1.cdpbin15)]./cdp_diff.*cdp_mean;
x_cas = cas_mean;
